...
const SettingsPage = () => {
  ...
  const handleThemeChange = (t) => {
    setTheme(t);
    localStorage.setItem("chatAppTheme", t); // ✅ Save to localStorage
  };
  ...
  return (
    <div className="h-screen container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
          ...
          {THEMES.map((t) => (
            <button
              ...
              className={`
                ...
                ${theme === t ? "border-primary bg-primary/10" : "border-transparent hover:bg-base-200/50"}
              `}
        ...
        {/* ✅ Reset Theme Button */}
        <button onClick={resetTheme} className="btn btn-outline flex items-center gap-2">
